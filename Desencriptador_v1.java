...
public class Desencriptador_v1 {
    ...
    private int valor;
    private Desencriptador_v1 padre;
    private Desencriptador_v1 raiz;
    private ArrayList<Desencriptador_v1> hijos;
     ...
     * @param "raiz"  Primer elemento del árbol
     */
    public Desencriptador_v1() {
        this.valor = valor;
        this.padre = padre;
        this.hijos = hijos;
        this.raiz = raiz;
    ...
    public Desencriptador_v1 getPadre() {
        return padre;
    }

    public Desencriptador_v1 getRaiz() {
        return raiz;
    }

    public ArrayList<Desencriptador_v1> getHijos() {
        return hijos;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ArrayList<Short> EDM = new ArrayList<Short>();
     ...
     * @param i     numero clave
     * @author dandevi
     * @author dancres
     */

    private static short insertar(short[] copia, int i) {
