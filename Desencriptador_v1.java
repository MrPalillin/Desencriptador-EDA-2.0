...
public class Desencriptador_v1 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 65535; i++) {
            ...
            ofuscar(copia, i);
            String resultado=copia.toString();
            EDM[i]=insertar(resultado,i);
            }
        } catch (IOException e) {
    ...
    private static short insertar(String resultado, int i) {
        short[] EDM=new short[65535];
        EDM[i]=resultado.toCharArray();
    }
